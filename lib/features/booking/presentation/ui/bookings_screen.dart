                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const SizedBox(height: 8),
                      Text('Start Date: ${_dateFormat.format(DateTime.parse(booking.startDate))}',
                          style: TextStyle(color: AppColors.kOxfordBlue),),
                      Text('End Date: ${_dateFormat.format(DateTime.parse(booking.endDate))}',
                          style: TextStyle(color: AppColors.kOxfordBlue),),
                      const SizedBox(height: 16),
                      Text(
                        'Car Details',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  context
                      .read<AddBookingBloc>()
                      .add(AcceptBooking(booking.id, userId!));
                  Navigator.of(context).pop();
                },
                child: const Text(
                  "Accept booking",
                  style: TextStyle(fontSize: 16, color: AppColors.kOxfordBlue),
                ),
              ),
            ),
            const SizedBox(height: 8),
