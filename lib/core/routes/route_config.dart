...
import 'package:infi_wheel/features/map_home/presentation/ui/car_details.dart';
...
class InfiWheelRouter {
  ...
  static Widget _detailsPageRouteBuilder(BuildContext context, GoRouterState state) => const CarDetails();
  ...
  static final GoRouter _router = GoRouter(
    routes: <GoRoute>[
      ...
      GoRoute(path: RoutePaths.details, builder: _detailsPageRouteBuilder),
    ]
  );
