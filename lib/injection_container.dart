...
void setupLocator() {
  ...
  getIt.registerFactory(() => AcceptBookingUseCase(getIt()));
  ...
  getIt.registerFactory(() => AddBookingBloc(addBookingUseCase: getIt(), getUserBookingsUseCase: getIt(), cancelBookingUseCase: getIt(), acceptBookingUseCase: getIt()));
}